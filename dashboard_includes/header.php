...
<body>
  ...
  <div class="sl-sideleft">
    ...
    <div class="sl-sideleft-menu">
      <a href="/Vespa/admin.php" class="sl-menu-link">
      ...
      <?php if ($_SESSION['role'] != 0) { ?>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="/Vespa/users/users.php" class="nav-link">User Info</a></li>
          <?php if ($_SESSION['role'] != 0 && $_SESSION['role'] != 3) { ?>
            <li class="nav-item"><a href="/Vespa/users/trash.php" class="nav-link">Trash</a></li>
          <?php } ?>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="/Vespa/skills/skills.php" class="nav-link">Skill Info</a></li>
          <?php if ($_SESSION['role'] != 0 && $_SESSION['role'] != 3) { ?>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="/Vespa/projects/projects.php" class="nav-link">Project Info</a></li>
          <?php if ($_SESSION['role'] != 0 && $_SESSION['role'] != 3) { ?>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="/Vespa/experience/experience.php" class="nav-link">Experience Info</a></li>
          <?php if ($_SESSION['role'] != 0 && $_SESSION['role'] != 3) { ?>
            <li class="nav-item"><a href="/Vespa/experience/add_experience.php" class="nav-link">Add Experience</a></li>
          <?php } ?>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="/Vespa/blogs/blog.php" class="nav-link">Blog Info</a></li>
          <?php if ($_SESSION['role'] != 0 && $_SESSION['role'] != 3) { ?>
            <li class="nav-item"><a href="/Vespa/blogs/add_blog.php" class="nav-link">Add Blog</a></li>
          <?php } ?>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="/Vespa/menus/menus.php" class="nav-link">Menu Info</a></li>
          <li class="nav-item"><a href="/Vespa/submenu/submenus.php" class="nav-link">SubMenu Info</a></li>
          <?php if ($_SESSION['role'] != 0 && $_SESSION['role'] != 3) { ?>
            <li class="nav-item"><a href="/Vespa/menus/add_menu.php" class="nav-link">Add Menu</a></li>
            <li class="nav-item"><a href="/Vespa/submenu/add_submenu.php" class="nav-link">Add SubMenu</a></li>
          <?php } ?>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="/Vespa/social/icons.php" class="nav-link">Icons Info</a></li>
          <?php if ($_SESSION['role'] != 0 && $_SESSION['role'] != 3) { ?>
            <li class="nav-item"><a href="/Vespa/social/add_icon.php" class="nav-link">Add icon</a></li>
          <?php } ?>
        </ul>
      ...
      <nav class="nav">
        <div class="dropdown">
          <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
            ...
            <img src="/Vespa/uploads/users/<?= $_SESSION['profile_photo'] ?>" class="wd-32 rounded-circle" alt="">
          </a>
